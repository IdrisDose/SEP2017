...
Route::get('/profile/{id}/dload', 'PageController@downloadRecord')->name('profile.download');
...
Route::group(['middleware'=>'auth'],function(){
	...
	Route::post('/profile/{id}/avatar', 'PageController@avatar')->name('profile.avatar');
	Route::post('/profile/{id}/record', 'PageController@record')->name('profile.record');
});
